...
bool atualizarJogo(int id) {
    ...
    switch (opcao) {
        case 1: partes[1] = " Nome: " + novoValor; break;
        case 2: partes[2] = " Genero: " + novoValor; break;
        case 3: partes[3] = " Plataforma: " + novoValor; break;
        case 4: partes[4] = " Ano: " + novoValor; break;
        case 5: partes[5] = " Desenvolvedor: " + novoValor; break;
        default:
    ...
    for (size_t i = 0; i < partes.size(); ++i) {
        ...
        if (i < partes.size() - 1) linhas[linhaJogo] += ";";
    }
