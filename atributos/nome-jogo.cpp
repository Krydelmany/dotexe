...
/**
 * @brief Função para gravar o nome e o gênero do jogo em um arquivo.
 * 
 * Esta função abre um arquivo chamado "jogos.txt" em modo de adição (append) e escreve
 * o nome e o gênero do jogo fornecido como parâmetro no arquivo. Se o arquivo não puder ser aberto,
 * uma mensagem de erro será exibida.
 * 
 * @param id O ID do jogo a ser gravado no arquivo.
 * @param nomeJogo O nome do jogo a ser gravado no arquivo.
